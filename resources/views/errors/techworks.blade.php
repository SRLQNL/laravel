...
<head>
    ...
    <meta name="description" content="{{$settings->namesite}} " />
    ...
    <meta property="og:title" content="{{$settings->namesite}}">
...
<div class="center">
    ...
    <div>
       The site is temporarily unavailable.
        <br><br>
        <a href="https://telegram/{{$settings->vk_url}}" target="_blank">follow the news</a>
    </div>
</div>
</body>
</html>
