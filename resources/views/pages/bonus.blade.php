...
<div class="bonus_page_wrapper">
    ...
    <div class="bonus_page_container">
        <div class="bonus_option" onclick="$('#wheel').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description">ПSpin the free wheel with a bonus<br>every 3 minutes!</div>
        ...
        <div class="bonus_option" onclick="$('#ref').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_name">Affiliate programs</div>
        ...
        <div id="notificationOption" style="display: none" class="bonus_option">
            ...
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description">Subscribe to notifications with promotional codes and news and receive &nbsp;<i class="fad fa-coins"></i>to the account!</div>
    ...
    <div class="bonus_page_container">
        <div class="bonus_option" onclick="window.open('https://vk.com/')">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description" style="margin-bottom: 64px;">Are you an administrator of a VKontakte group? We can offer daily unique promotional codes for your groupsы.</div>
