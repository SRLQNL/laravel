    ...
    <div class="carousel">
        <div>
            <div class="carousel-slide">
                <div class="carousel-background" style="background-image: url(/img/3.jpg);"></div>
               <br> <div class="carousel-content">
                    <div class="slide-header">
                       Promo codes
                    </div>
                    <div class="slide-content">
                       Do you want to stay up to date with the news? Receive free bonuses? Promotional codes, sweepstakes and much more.<br>
                       Visit us on Telegram- <a class="ll" href="" target="_blank">GMESX</a>
                    </div>
                </div>
                <button class="slide-button" onclick="window.open('', '_blank')">Go</button>
            </div>
        </div>
        <div>
            <div class="carousel-slide">
                <div class="carousel-background" style="background-image: url(/img/2.jpg);"></div>
                <br><br><div class="carousel-content">
                    <div class="slide-header">
        ...
        <div>
            <div class="carousel-slide">
                <div class="carousel-background" style="background-image: url(/img/1.jpg);"></div>
               <br><br> <div class="carousel-content">
                    <div class="slide-header">
                       Start from scratch!
                    </div>
                    <div class="slide-content">
                    Start from scratch to become richer and more successful,<br>get a daily bonus of up to $10 to start earning real cash. 
                    </div>
                </div>
	...
	<div class="welcome_Welcome__rQYTl">
            ...
            <img src="/img/Slide2.webp" loading="lazy" alt="" width="100%">
                ...
                <div class="welcome_Left__JPT6w">
                    ...
                    <div class="welcome_Intro__3Zo-O">GMESX – Instant games with money withdrawal. The best licensed site for relaxation and earning money.
                    </div>
					@php
                    ...
                    <div class="welcome_Counters__2BjGU">
                        ...
                        <div class="welcome_Item__3ifzJ">
                            <div class="welcome_Label__2pEjZ">Withdrawn</div>{{$pw}} <i style="font-size: 19px;" class="far fa-dollar-sign"></i></div>
                    </div>
                     <div class="welcome_Counters__2BjGU">
...
<div class="col-xs-12" style="margin-top: 10px">
  ...
  <!---  <div class="col-xs-12">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-mines" onclick="{{$link('mines')}}" style="background-image: url('/img/mines.png')">
            {{$overlay('mines')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-crash" onclick="{{$link('crash')}}" style="background-image: url('/img/crash.png')">
		{{$overlay('crash')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-wheel" onclick="{{$link('wheel')}}" style="background-image: url('/img/wheel.png')">
            {{$overlay('wheel')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-dice" onclick="{{$link('dice')}}" style="background-image: url('/img/dice.png')">
            {{$overlay('dice')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-coinflip" onclick="{{$link('coinflip')}}" style="background-image: url('/img/coin.png'); background-position-y: top; background-size: cover;">
            {{$overlay('coinflip')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-hilo" onclick="{{$link('hilo')}}" style="background-image: url('/img/hilo.png')">
            {{$overlay('hilo')}}
            <div class="i_game-name">
                <i class="icon-hilo"></i>
                HiLo
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-blackjack" onclick="{{$link('blackjack')}}" style="background-image: url('/img/black.png')">
            {{$overlay('blackjack')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-tower" onclick="{{$link('tower')}}" style="background-image: url('/img/tower.png')">
            {{$overlay('tower')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-roulette" onclick="{{$link('roulette')}}" style="background-image: url('/img/rool.png')">
            {{$overlay('roulette')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-stairs" onclick="{{$link('stairs')}}" style="background-image: url('/img/stairs.png')">
            {{$overlay('stairs')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-keno" onclick="{{$link('keno')}}" style="background-image: url('/img/keno.png')">
            {{$overlay('keno')}}
            <div class="i_game-name">
                <i class="icon-keno"></i>
                Keno
	...
	<div class="col-xs-13 col-sm-6 col-md-4">
        <div class="i_game i_game-plinko" onclick="{{$link('plinko')}}" style="background-image: url('/img/plinko.png')">
            {{$overlay('plinko')}}
            <div class="i_game-name">
    ...
    <div class="col-xs-13 col-sm-6 col-md-5">
        <div class="i_game i_game-bonus" @if(!Auth::guest()) onclick="load('/bonus')" @else onclick="$('#b_si').click()" @endif>
            ...
            <div class="i_game-name" id="bonus_banner_name">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="i_game i_game-vk" onclick="var win = window.open('https://vk.com/', '_blank'); win.focus()" id="vk_banner">
            <i class="fab fa-telegram i_game_overlay-vk"></i>
            <div class="i_game-name vk_banner_desc" id="vk_banner_name">
                <i class="fab fa-telegram i_b_i"></i><span class="i_b_i">Telegram</span><br>
              Join the Telegram group<br>
