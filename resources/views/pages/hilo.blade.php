    ...
    <div class="col-md-3 col-sm-12 g_sidebar g_sidebar_nm" data-parent="#w_container">
        <div class="row g_follow">
            ...
            <div class="col-xs-12 coin-select">
                ...
                <div class="hilo-select" onclick="flip('higher')" style="display: none">
                    ...
                    <div class="hilo-chance-desc" id="higher">Above or the same</div>
        ...
        <div class="g_sidebar_footer">
            <div class="g_sidebar_footer_button" onclick="info('hilo')">
                <i class="fas fa-info-circle tooltip" title="Information about the game"></i>
            </div>
            <div class="g_sidebar_footer_button" onclick="provablyfair()">
                ...
                <div class="fad fa-volume-up tooltip" id="game_audio_on" style="display:none" title="Turn off the sound"></div>
				<div class="fad fa-volume-slash tooltip" id="game_audio_off" style="display:none" title="sound"></div>
            </div>
        </div>
    </div>
