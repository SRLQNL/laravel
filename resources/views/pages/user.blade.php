                            ...
                            <tbody>
                                @foreach($drops as $d)
                                    <tr class="live_table-game">
                                        ...
                                        <th class="hidden-xs">Top up your balance {{$d->amount}} $</th>
                                        <th>{{$d->amount}} $</th>
                            ...
                            <tbody>
                                @foreach($drops as $d)
                                    <tr class="live_table-game1">
                                        ...
                                        <th class="hidden-xs">
                                            Payment for the amount {{$d->amount}} $
                                        ...
                                        <th>
                                            @if($d->status == 0)
                                               Expectation
                                                <br>
                                                <a class="ll" onclick="cancelWithdraw({{$d->id}})" href="javascript:void(0)">Сancel</a>
                                            @elseif($d->status == 1)
                                                Succes
                                            @elseif($d->status == 2)
                                               Denied
                            ...
                            <div class="levels-table">
                                @for($i = 1; $i <= 10; $i++)
                                    <div class="level">
                                        ...
                                        @elseif($i == Auth::user()->level + 1) <div class="level-desc level-{{$i}}">Amount of experienceа: {{Auth::user()->exp}}/{{\App\User::getRequiredExperience($i)}}</div>
                                        @elseif($i < Auth::user()->level) <div class="level-desc level-{{$i}}"><i class="fal fa-check"></i> You got this level</div> @endif

                                        @if($i > 1 && $i >= Auth::user()->level) <div class="level-desc @if($i == Auth::user()->level) level-4 @else level-1 @endif">Extra Bonus: +{{\App\User::getBonusModifier($i)}} руб</div> @endif
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9">
                            ...
                            <div class="user-exp">
                               Additional bonus:
                                <span>
                                    @if($user->level > 1)
                                        {{\App\User::getBonusModifier($user->level)}} $
                                    @else
                                        Нет
                                    @endif
                                </span>
                            ...
                            @if($user->level < 10)
                                <div class="user-exp" style="margin-top: 15px">
                                  Experience up to {{$user->level + 1}} lvl:
                            ...
                            <div class="faq">
                                ...
                                <div class="faq-block">
                                    ...
                                    <div class="faq-content">
                                      An additional bonus is an amount that is guaranteed to be added to your account after spinning the wheel on the pagesе <a href="javascript:void(0)" onclick="load('/bonus')" class="ll">bonus</a>
                                    </div>
                                </div>
                                @if($user->level < 10)
                                    <div class="faq-block">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                 2. Getting achievements<hr>
                                                    ...
                                                    <br>
                                                    <a href="javascript:void(0)" onclick="setTab('achievements')" class="ll">Find out more</a>
                                                </li>
                                                <li>
                                                    3. Topping up your account<hr>
                                                     - Every 10 $ increases your experience by 10%.
                                                    @if($user->level < 3)
                                                    <br>
               ...
               <div class="user_tab" id="ref">
                    <div class="col-xs-12 col-sm-12 col-md-9">
                        ...
                        Invite your friends and earn bonuses together!<br>
                             Each person who registers using your referral code will receive {{$settings->promo_sum}} $

                            <br><br>
                         As a reward for everyone<span class="ref_bb">active referral</span> <i class="fas fa-question-circle fqc tooltip" title="An active referral is considered to be one whose total winnings from all games have reached 50$"></i> You are getting {{$settings->promo_sum}} $,<br>
...
<div class="fn_form_block">
			...
			<br><br>
			 <div class="ref-header">Secure</div>
			 <div class="ref-content">
			...
			@if(Auth::user()->password != null)
                ...
                <div class="login_fields__user" id="oldpassword" style="display: block;">
                    ...
                    <i class="fas fa-info-circle register-email-info tooltip" title="Current password used for authorization."></i>
                </div>
                <div class="login_fields__user">
                    <div class="icon user-icon">
                        <img src="/img/lock_icon_copy.png" alt="">
			...
			<br><br>
<br><br>
										 <div class="ref-header">Fair games</div>
										 <div class="ref-content">
                            <div class="fn_form_block">
                <p>Сlients hash</p>
