    ...
    <div class="col-md-3 col-sm-12 g_sidebar" data-parent="#w_container">
        <div class="row g_follow">
            <div class="row m0">
                <div class="g_md_n col-md-12">
                    ...
                    <span>Roulette</span>
								...
								<div class="game-sidebar-tabs"><div class="game-sidebar-tab active" onclick="setMode('default')" data-tab="default">Manual</div></div>
                <div class="col-xs-12">
                    <div class="b_label">
                      Select a chip
                    </div>
            ...
            <div class="col-xs-12 col-sm-12 mt10">
                ...
                <div class="g_s g_btn" onclick="rouletteauto()" id="auto" style="display: none;"><span id="bet_btn_auto">Start</span></div>
            </div>
        </div>
        <div class="g_sidebar_footer">
			...
			<script>$(document).ready(function(){$('#game_quick').toggleClass('demo_active', isQuick)});</script>
                ...
                <div class="fad fa-volume-up tooltip" id="game_audio_on" style="display:none" title="Sound off"></div>
				<div class="fad fa-volume-slash tooltip" id="game_audio_off" style="display:none" title="On sound"></div>
            </div>
        </div>
    </div>
    <div id="w_container" class="g_c g_container roulette col-md-9 col-sm-12">
        ...
        <div class="roulette-container">
            <div class="roulette-header">
                <div class="roulette-bet">Amount: <span id="token_bet">0.00 &nbsp;<i class="fad fa-coins"></i></span></div>
