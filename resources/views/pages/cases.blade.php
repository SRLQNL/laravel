                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5">
                            <div class="case-container" data-case-id="{{$box->id}}">
                                ...
                                <div class="case-footer">
                                    ...
                                    <button @if($box->is_free == 1 && !\App\Box::isFreeAvailable()) data-disabled="true" @endif class="case-purchase @if($box->is_free == 1 && !\App\Box::isFreeAvailable()) case-btn-disabled @endif" data-case="{{$box->id}}">Open</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
