...
.buttons-2-selected:hover {
    box-shadow: inset 0 0 0 23px #4986f5;
                ...
                <div class="buttons-2">
                    <div onclick="autopick()" class="buttons-2-selected"><i class="fas fa-magic"></i>&nbsp; Auto-selectр</div>
            ...
            <div class="col-xs-12 col-sm-12 mt5">
                <div class="g_s g_btn" onclick="keno()" id="play"><span id="bet_btn">Play</span></div>
						...
						<div class="col-xs-12 col-sm-12 mt5">
                <div class="g_s g_btn" onclick="kenoauto()" id="auto" style="display: none;"><span id="bet_btn_auto">Start</span></div>
            </div>
        </div>
        <div class="g_sidebar_footer">
            ...
            <div class="g_sidebar_footer_button" onclick="provablyfair()">
                <i class="fad fa-shield-alt tooltip" title="Fair gamesа"></i>
            </div>
				...
				<div class="fad fa-volume-slash tooltip" id="game_audio_off" style="display:none" title="Sound on"></div>
            </div>
        </div>
    </div>
...
@media(max-width: 500px) {
    /* .irs-grid-pol.small{
		...
		<div class="outcome-window outcome-window_won outcome-window_centered">
                                                ...
                                                <div class="outcome-window__text outcome-window_won__text">You win
