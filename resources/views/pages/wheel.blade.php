    ...
    <div class="col-md-3 col-sm-12 g_sidebar" data-parent="#w_container">
        <div class="row g_follow">
            <div class="row m0">
				...
				<div class="game-sidebar-tabs"><div class="game-sidebar-tab active" onclick="setMode('default')" data-tab="default">Manual</div><div class="game-sidebar-tab" onclick="setMode('auto')" data-tab="auto">Аuto</div></div>
                <div class="col-xs-12">
                    <div class="b_label">
                ...
                <div class="col-xs-12">
                    <div class="bet_profit">
                        ...
                        <div class="hidden-xs mt5">
                           Colors: <span id="w_color" class="bet_profit-error">Not chosen</span>
                        </div>
                    </div>
                </div>
            </div>
			...
			<div class="col-xs-12 col-sm-12 mt5">
                <div class="g_s g_btn" onclick="wheelauto()" id="auto" style="display: none;"><span id="bet_btn_auto">Start</span></div>
            </div>
        </div>
        <div class="g_sidebar_footer">
            <div class="g_sidebar_footer_button" onclick="info('wheel')">
                <i class="fas fa-info-circle tooltip" title="INFORMATION"></i>
            </div>
			...
			<script>$(document).ready(function(){$('#game_quick').toggleClass('demo_active', isQuick)});</script>
                <i class="fas fa-bolt tooltip" id="game_quick" title="FAST GAMES"></i>
            </div>
