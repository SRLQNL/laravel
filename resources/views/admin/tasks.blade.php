                        ...
                        <div class="kt-widget__body">
                            ...
                            <div class="kt-widget__content">
                                <div class="kt-widget__details">
                                    ...
                                    <span class="kt-widget__value">{{$task->reward}} <span>$.</span></span>
                                </div>
                                <div class="kt-widget__details">
                                    <span class="kt-widget__subtitle">Price for 1 attempt</span>
                                    <span class="kt-widget__value">{{$task->price}} <span>$.</span></span>
                                </div>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-control-label">Reward:</label>
                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                        <input id="reward" type="text" class="form-control" value="0.00" placeholder="Reward">
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-control-label">Game:</label>
                ...
                <div class="form-group">
                    <label class="form-control-label">Meaning:</label>
