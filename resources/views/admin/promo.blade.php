        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="form-control-label">Number of promotional codes:</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <span class="form-text text-muted"><a href="javascript:void(0)" onclick="$('#code').val((Math.random() +1).toString(36).substr(2, 6).toUpperCase())">Generate</a></span>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Сancel</button>
