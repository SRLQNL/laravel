                    ...
                    <div class="kt-form" id="kt_form">
                        ...
                        <div class="kt-wizard-v2__content" data-ktwizard-type="step-content">
                            ...
                            <div class="kt-form__section kt-form__section--first">
                                <div class="kt-wizard-v2__form">
                                    <div class="form-group">
                                      <label>Probability of <strong>losing</strong> with odds 1.01 - 1.50</label>
                                    ...
                                    <div class="form-group">
                                      <label>Probability of <strong>losing</strong> with odds 1.51 - 2.50</label>
                                    ...
                                    <div class="form-group">
                                      <label>Probability of <strong>losing</strong> with odds 2.51 - 4.00</label>
                                    ...
                                    <div class="form-group">
                                      <label>Probability of <strong>losing</strong> with odds 4.01 - 10.00</label>
                        ...
                        <div class="kt-wizard-v2__content" data-ktwizard-type="step-content">
                            ...
                            <div class="kt-form__section kt-form__section--first">
                                <div class="kt-wizard-v2__form">
                                    <div class="form-group">
                                      <label>Probability of <strong>losing</strong> x36</label>
                                    ...
                                    <div class="form-group">
                                      <label>Probability of <strong>losing</strong> x3</label>
                                    ...
                                    <div class="form-group">
                                       <label>Probability of <strong>losing</strong> x2</label>
