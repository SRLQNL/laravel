                                            ...
                                            <div id="with_{{$live->id}}" class="kt-widget4__item">
                                                ...
                                                <div class="kt-widget4__info">
                                                    <a href="javascript:void(0)" onclick="load('/admin/user?id={{$live->user->id}}')" class="kt-widget4__username">
                                                        {{$live->user->username}} <i class="fas fa-angle-right"></i> {{$live->user->money}} $.
                                                    </a>
                                                    <p class="kt-widget4__text" style="font-family: 'Open Sans', sans-serif">
                                                        {{$live->amount}} $. <i class="fal fa-angle-right"></i> {{\App\Http\Controllers\GeneralController::formatDate(strtotime($live->created_at))}}
                                                        <br>
                                                        @php 
														$s = '' 
														@endphp
                                        ...
                                        <div id="with_{{$live->id}}" class="kt-widget4__item">
                                            ...
                                            <div class="kt-widget4__info">
                                                ...
                                                <p class="kt-widget4__text">
                                                    +{{$live->amount}} $. <i class="fal fa-angle-right"></i> ({{$live->type}}) <br> {{\App\Http\Controllers\GeneralController::formatDate(strtotime($live->created_at))}}
                                                </p>
                                            </div>
                                        </div>
                                    @endforeach
