                ...
                <div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        @if(Auth::user()->chat_role >= 3)
							...
							</span><span class="kt-menu__link-text">Task</span></a>
                            </li>
							@endif
                        @endif
                        <li class="kt-menu__section ">
                      ...
                      <!--  <li class="kt-menu__item" data-option="admin/promo_list" aria-haspopup="true"><a href="javascript:void(0)" onclick="load('/admin/promo_list')" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                        ...
                        @if(Auth::user()->chat_role >= 3)
							...
							</span><span class="kt-menu__link-text">Withdraw</span></a>
                            </li>
							...
							</span><span class="kt-menu__link-text">Invest</span></a>
                            </li>
                            ...
                            </svg></span><span class="kt-menu__link-text">Creatie</span>
                                    <span class="kt-menu__link-badge bigger-badge">
    ...
    <div class="kt-quick-panel__nav">
        <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand  kt-notification-item-padding-x" role="tablist">
            <li class="nav-item active">
                <a class="nav-link active" data-toggle="tab" href="#kt_quick_panel_tab_settings" role="tab">Game</a>
            </li>
        </ul>
    </div>
